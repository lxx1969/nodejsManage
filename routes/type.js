...
router.post('/getTypeList', async (req, res) => {
    try {
        const sql = "select type_name,type_logo,type_id,detail_model,type_name_list,modulo_list from type_list "
        const typeSql = "select game_name,type_game_id,stream from type_game_list where type_id = ? "
