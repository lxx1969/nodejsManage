...
router.post('/getGameList', async (req, res) => {
  try {
    ...
    let sql =
      "SELECT t.game_name,g.title,g.min_chip,g.max_chip,g.is_show,g.type_game_id,g.game_id,g.end_time,g.max_bet,g.min_bet,g.game_detail,g.end_block,g.is_auto_pass,g.clear_block from game as g join type_game_list as t on t.type_game_id = g.type_game_id where 1=1";
